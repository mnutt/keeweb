...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "h6eqhj9ppsgm852973gt1jn1knjzagfmjrtfe676g944h8mtvep0",
  ...
  manifest = (
    ...
    actions = [
      ...
      ( title = (defaultText = "password file"),
        command = .myCommand
    ...
    metadata = (
      ...
      codeUrl = "https://github.com/JamborJan/keeweb-sandstorm",
      ...
      screenshots = [
        ...
        (width = 1166, height = 675, png = embed "app-graphics/keeweb_example_01.png"),
        (width = 1166, height = 675, png = embed "app-graphics/keeweb_example_02.png"),
        (width = 1166, height = 675, png = embed "app-graphics/keeweb_example_03.png"),
        (width = 1166, height = 675, png = embed "app-graphics/keeweb_example_04.png"),
      ],
...
const myCommand :Spk.Manifest.Command = (
  ...
  environ = [
    ...
    (key = "STORAGE_PATH", value = "/var/keeweb/data"),
    (key = "TEMP_STORAGE_PATH", value = "/var/keeweb/tmp"),
